...
expName = 'experiment_sep1'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/seven/Desktop/classes/experiment_sep1_lastrun.py',
...
conditions = data.importConditions('conditions sep 1.xlsx')
